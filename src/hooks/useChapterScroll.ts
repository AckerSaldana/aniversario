 ...
 */
export function useChapterScroll({ ref, chapterId, enabled = true }: Options) {
  useEffect(() => {
    ...
    const tick = () => {
      ...
      // Activar el capítulo cuando estamos cerca del centro de la sección
      if (p > 0.3 && p < 0.7) {
